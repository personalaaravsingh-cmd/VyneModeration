...
async function resolveTrack(query, requester, player) {
  ...
  try {
    ...
    return {
      ...
      thumbnail: info.artworkUrl || lavaTrack.pluginInfo?.artworkUrl || info.thumbnail || lavaTrack.pluginInfo?.albumArtUrl || null,
      artworkUrl: info.artworkUrl || lavaTrack.pluginInfo?.artworkUrl || info.thumbnail || lavaTrack.pluginInfo?.albumArtUrl || null,
...
async function autoplayTrack(client, guildId, sourceTrack = null) {
  ...
  try {
    ...
    return {
      ...
      duration,
      durationText: formatDuration(duration),
      thumbnail: info.artworkUrl || candidate.pluginInfo?.artworkUrl || info.thumbnail || candidate.pluginInfo?.albumArtUrl || null,
      artworkUrl: info.artworkUrl || candidate.pluginInfo?.artworkUrl || info.thumbnail || candidate.pluginInfo?.albumArtUrl || null,
